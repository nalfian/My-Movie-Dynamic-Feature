...
import id.localrental.movie_feature.R
import id.localrental.sample4.base.ItemClickListener

import kotlinx.android.synthetic.main.item_movie.view.*

class AdapterMovie(
    private val context: Context,
    private val movieList: List<id.localrental.sample4.data.db.entity.Movie>,
